...
module.exports = function (env) {
    ...
    const API_URL = process.env.API_URL || 'http://' + HOST + ':' + PORT + '/api';
    ...
    return webpackMerge(commonConfig({env: ENV, metadata: METADATA}), {
        ...
        module: {
            rules: [
                /**
                 * Extract CSS files from .Source/styles directory to external CSS file
                 */
                {
                    test: /\.css$/,
                    use: [MiniCssExtractPlugin.loader, 'css-loader'],
                    include: [helpers.root('Source', 'styles')]
                },

                /**
                 * Extract and compile SCSS files from .Source/styles directory to external CSS file
                 */
                {
                    test: /\.scss$/,
