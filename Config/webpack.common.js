...
module.exports = function(options) {
  ...
  const entry = {
    polyfills: './Source/polyfills.browser.ts',
  ...
  return {
    ...
    resolve: {
       ...
       */
      modules: [helpers.root('Source'), helpers.root('node_modules')],
    ...
    module: {
      rules: [
         ...
         */
        {
          ...
          exclude: [helpers.root('Source', 'styles')]
        },
    ...
    plugins: [
      ...
      new CopyWebpackPlugin(
        [{ from: 'Source/assets', to: 'assets' }, { from: 'Source/meta' }],
